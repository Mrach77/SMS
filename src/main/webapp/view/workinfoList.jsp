        ...
        <c:forEach items="${workinfoList}" var="v">
            <tr>
                ...
                <td style="width: 180px;">
                    <a href="${ctx}/view/homeworkAdd.jsp?wname=${v.wname}"
                            class="layui-btn layui-btn-normal layui-btn-sm ">提交作业
                    </a>
                    <button path="${ctx}/workinfo/detail?id=${v.wid}"
                            class="layui-btn layui-btn-normal layui-btn-sm showDetail">查看详情
                    </button>
                </td>
            </tr>
        </c:forEach>
