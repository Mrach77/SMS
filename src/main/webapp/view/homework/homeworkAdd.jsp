...
<div class="layui-container">
    ...
    <form class="layui-form  layui-form-pane" action="${ctx}/homework/insert" method="post" style="margin: 50px auto;">

        <div class="layui-form-item">
            <label class="layui-form-label">作业名称</label>
            <div class="layui-input-block">
                <input type="text" name="swname" id="swname" value="" lay-verify autocomplete="off"
                       placeholder="请输入作业名称"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="swuser" id="swuser" value="" lay-verify autocomplete="off"
                       placeholder="请输入提交用户"
                       class="layui-input">
            </div>
        </div>
