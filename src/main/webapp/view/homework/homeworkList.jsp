        ...
        <tr>
            ...
            <td>${v.swtime}</td>
			  <td style="width: 180px;">
                <a href="${ctx}/homework/edit?id=${v.swid}" class="layui-btn layui-btn layui-btn-sm">修改</a>
                <a href="${ctx}/homework/delete?id=${v.swid}" class="layui-btn layui-btn-danger layui-btn-sm">删除</a>
