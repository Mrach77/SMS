        ...
        <c:forEach items="${noticeinfoList}" var="v">
            <tr>
                ...
                <td style="width: 180px;">
                    <a href="${ctx}/noticeinfo/edit?id=${v.noticeid}" class="layui-btn layui-btn layui-btn-sm">修改</a>
                    <a href="${ctx}/noticeinfo/delete?id=${v.noticeid}" class="layui-btn layui-btn-danger layui-btn-sm">删除</a>
