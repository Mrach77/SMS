...
<div class="layui-container">
    ...
    <form class="layui-form  layui-form-pane" action="${ctx}/homework_update" method="post" style="margin: 50px auto;">
...
<script>
    ...
    layui.use(['element', 'layer', 'jquery', 'form', 'laydate', 'layedit'], function () {
        ...
        layedit.setContent(contentIndex, '${homework.swcontent}'); //赋值
        //编辑器内容同步到表单元素中
        form.verify({
